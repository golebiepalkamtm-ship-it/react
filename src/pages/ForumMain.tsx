...
import { MessageCircle, Stethoscope, Trophy, ShoppingBag, ArrowRight } from 'lucide-react';
                    ...
                    <div className="container mx-auto px-4 text-center">
                        <RevealOnScroll direction="up">
                            ...
                            <p className="text-xl text-white/70 max-w-2xl mx-auto mb-12">
                                Dołącz do dyskusji, dziel się wiedzą i buduj przyszłość polskiego sportu gołębiarskiego.
                            </p>
                        </RevealOnScroll>
                    </div>
                </SeamlessSection>
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center gap-6">
                                                        <div className="flex flex-col">
                                                            <span className="text-2xl font-bold text-white">{category.topics_count || 0}</span>
                                                            <span className="text-[10px] uppercase tracking-widest text-white/40">Tematów</span>
                                                        </div>
                                                        <div className="h-8 w-px bg-white/10" />
                                                        <div className="flex flex-col">
                                                            <span className="text-2xl font-bold text-white">{category.posts_count || 0}</span>
                                                            <span className="text-[10px] uppercase tracking-widest text-white/40">Postów</span>
                                                        </div>
