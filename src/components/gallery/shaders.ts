 ...
 * 
 * Kolory projektu:
 * - Primary: hsl(48, 40%, 56%) - #c0a052 (stare złoto)
 * - Gold: hsl(45, 38%, 47%) - #b08d3b (stare złoto)
...
export const backgroundNoiseShader = `
  ...
  const vec3 gold = vec3(0.690, 0.553, 0.231);      // #b08d3b - old gold
  const vec3 primary = vec3(0.753, 0.627, 0.322);   // #c0a052 - old gold light
...
export const shaderColors = {
  ...
  gold: 'vec3(0.690, 0.553, 0.231)',
  goldLight: 'vec3(0.753, 0.627, 0.322)',
  primary: 'vec3(0.753, 0.627, 0.322)',
