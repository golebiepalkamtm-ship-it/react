                        ...
                        <form onSubmit={onSave} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={auction.title}
                                    onChange={e => onChange({ ...auction, title: e.target.value })}
                                />
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={e => onChange({ ...auction, description: e.target.value })}
                                />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e => onChange({ ...auction, startingPrice: Number(e.target.value) })}
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e => onChange({ ...auction, buyNowPrice: Number(e.target.value) })}
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={e => onChange({ ...auction, status: e.target.value })}
                                >
