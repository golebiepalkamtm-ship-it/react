        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10 bg-white/5">
              ...
              <th className="text-center py-4 px-6 text-sm font-medium text-white/70">
                Status
              </th>
              <th className="text-right py-4 px-6 text-sm font-medium text-white/70">
                Akcje
            ...
            {auctions.map((auction, index) => (
              ...
              >
                ...
                <td className="py-4 px-6 text-center">
                  <span
                    className={`text-xs px-3 py-1 rounded-full ${auction.status === "ACTIVE" ? "bg-green-500/20 text-green-400" : "bg-white/10 text-white/60"}`}
                  >
