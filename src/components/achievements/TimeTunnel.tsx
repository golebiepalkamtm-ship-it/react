...
const timelineEvents = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Okręg Jelenia Góra (nieuznane) – Kat A: Mistrz (69.22 coeff, 18 kon)",
      "Okręg Jelenia Góra (nieuznane) – Kat B: Mistrz (81.30 coeff, 15 kon)",
      "Okręg Jelenia Góra (nieuznane) – Kat C: 3 Przodownik (561.95 coeff, 12kon)",
      ...
      "Region V (nieuznane) – Kat D: II V-ce Mistrz (713.20 coeff, 42 kon)",
      "Region V (nieuznane) – Kat Derby: Mistrz 567.530 coeff 25 kon (Mistrz miał 757 a V-ce Mistrz 927)",
      "MP (nieuznane) – Kat A: I V-ce Mistrz (63.82 coeff, 18 kon)",
      "MP (nieuznane) – Kat B: 2 Przodownik (70.75 coeff, 15 kon)",
      "MP (nieuznane) – Kat Derby: Mistrz 567.530 coeff 25 kon (Mistrz miał 757 a V-ce Mistrz 927)",
    ],
