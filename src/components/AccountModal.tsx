          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/70">
                Aby uzyskać pełny dostęp do serwisu i móc tworzyć aukcje oraz
                licytować, musisz uzupełnić wszystkie dane profilowe i przejść
                weryfikację SMS.
              </p>
            ...
            <div className="mb-6 p-4 bg-white/5 rounded-lg border border-white/10">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={`text-2xl font-bold ${reviewService.getRatingColor(trustScore)}`}
                  >
            ...
            >
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <input
                  ...
                  placeholder={
                    t("profile.street_placeholder") || "Ulica i numer"
                  }
                  className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50 transition-all duration-200 hover:bg-white/15"
                />
              </div>
      ...
      {loading ? (
        ...
        <div className="text-center space-y-3 py-6">
          <div className="text-foreground">
            Zaloguj się, aby zobaczyć panel konta
          </div>
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            onClick={() => {
              onClose();
              window.location.href = "/auth?mode=login&callbackUrl=/";
            }}
