      ...
      <div className="relative z-60 w-full py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div
              className="h-px w-0 bg-gold mx-auto mt-4 opacity-50"
              data-reveal-line
            />
          </div>
            ...
            >
              <MagneticButton strength={0.2}>
                <Button
                  asChild
                  size="lg"
                  className="bg-gold text-navy px-10 h-14 text-lg font-semibold shadow-[0_0_40px_rgba(212,175,55,0.3)] hover:shadow-[0_0_60px_rgba(212,175,55,0.6)] rounded-full transition-all duration-500"
                >
              ...
              <MagneticButton strength={0.2}>
                <Button
                  ...
                  asChild
                  size="lg"
                  className="border-white/20 hover:border-gold hover:bg-gold/10 text-white px-10 h-14 text-lg font-light rounded-full backdrop-blur-sm transition-all duration-500"
                >
