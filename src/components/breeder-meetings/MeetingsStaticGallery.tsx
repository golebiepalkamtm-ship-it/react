...
const GALLERY: { breeder: string; images: string[] }[] = [
  {
    ...
    images: [
      "/meetings-with-breeders/Geert Munnik/DSC_031.jpg",
      "/meetings-with-breeders/Geert Munnik/DSC_038.jpg",
      "/meetings-with-breeders/Geert Munnik/DSC_044.jpg",
    ...
    <section className="my-12">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-6 text-foreground">
          Zdjęcia ze <span className="text-gradient-gold">spotkań</span> z
          hodowcami
        </h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {group.images.map((src, idx) => (
                  <motion.button
                    key={src}
                    onClick={() =>
                      openGallery(group.images, idx, group.breeder)
                    }
                    className="rounded-xl overflow-hidden bg-transparent backdrop-blur-xl backdrop-brightness-125 border border-gold/30 shadow-[0_8px_24px_-4px_rgba(0,0,0,0.3)] group relative focus:outline-none gallery-card hover:border-gold/50 transition-all duration-300"
