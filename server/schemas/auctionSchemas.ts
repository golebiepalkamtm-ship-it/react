...
const categoryEnum = z.enum(["pigeons", "accessories", "supplements"]);
const categoryEnumUpper = z.enum(["PIGEONS", "ACCESSORIES", "SUPPLEMENTS"]);
...
export const createAuctionSchema = z
  .object({
    ...
    images: z
      .array(z.string().trim().min(1, "Image URL required"))
      .max(20, "Too many images")
      .optional(),
    videos: z
      .array(z.string().trim().min(1, "Video URL required"))
      .max(10, "Too many videos")
      .optional(),
    documents: z
      .array(z.string().trim().min(1, "Document URL required"))
...
export const queryParamsSchema = z.object({
  ...
  category: z.enum(["all", "pigeons", "accessories", "supplements"]).optional(),
